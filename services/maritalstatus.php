...
class MaritalStatus extends Service
{
  const TABLE = "AUX_MARITALSTATUS";

  public function list($params = [])
  {
    return $this->getDao(self::TABLE)
      ->bindParams($params)
      ->find('maritalstatus/read');
  }
